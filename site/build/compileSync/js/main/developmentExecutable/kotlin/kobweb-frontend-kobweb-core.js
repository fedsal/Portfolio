(function (factory) {
  ...
  var trimStart = kotlin_kotlin.$_$.ye;
  ...
  var replace = kotlin_kotlin.$_$.ie;
  ...
  var substringBefore = kotlin_kotlin.$_$.pe;
  var to = kotlin_kotlin.$_$.xg;
  var substringAfter = kotlin_kotlin.$_$.oe;
  ...
  function toResource($this, apiPath) {
    return Companion_getInstance_2().prependTo_e25c5r_k$('/api/' + trimStart(apiPath, charArrayOf([_Char___init__impl__6a9atx(47)])));
  }
  ...
  function Anchor(href, attrs, openInternalLinksStrategy, openExternalLinksStrategy, updateHistoryMode, content, $composer, $changed, $default) {
    ...
    if (!(($dirty & 74899) === 74898) || !$composer_0.get_skipping_3owdve_k$()) {
      ...
      var tmp_5 = Companion_getInstance_2().prependTo_e25c5r_k$(href);
      ...
      $composer_0.endReplaceGroup_ek144q_k$();
      A(tmp_5, tmp0_group, content_0._v, $composer_0, 896 & $dirty >> 9, 0);
    } else {
      $composer_0.skipToGroupEnd_lh3zi2_k$();
    }
  ...
  protoOf(Companion_1).prependTo_e25c5r_k$ = function (path) {
    return Companion_getInstance_3().get_instance_mmff6q_k$().prependTo_e25c5r_k$(path);
  };
  ...
  function createPageData(_this__u8e3s4, route, errorPageContent) {
    var errorPageMethod = ComposableLambda$invoke$ref(composableLambdaInstance(-2122374110, true, createPageData$lambda(errorPageContent)));
  ...
  function partitionPath($this, _this__u8e3s4) {
  ...
  function Router$renderActivePage$lambda$lambda($pageMethod) {
    return function ($composer, $changed) {
      ...
      if (!(($changed & 3) === 2) || !$composer_0.get_skipping_3owdve_k$()) {
        $composer_0.startMovableGroup_clfloq_k$(1960041499, Companion_getInstance_0().get_instance_vwsfsk_k$().get_route_iy3cio_k$().get_path_wos8ry_k$());
        $pageMethod(Companion_getInstance_0().get_instance_vwsfsk_k$(), $composer_0, 0);
    ...
    return function (mutations, observer) {
      ...
      while (inductionVariable < last) {
        ...
        if (element.type === 'childList') {
          // Inline function 'kotlin.collections.isNotEmpty' call
          tmp = !asList(element.addedNodes).isEmpty_y1axqb_k$();
        } else {
          tmp = false;
        }
        if (tmp) {
  ...
  function Router() {
    ...
    this.errorPageMethod_1 = ComposableSingletons$RouterKt_getInstance().lambda$231942886__1;
  }
  ...
  protoOf(Router).register_wqi1wu_k$ = function (route, pageMethod) {
    ...
    // Inline function 'kotlin.require' call
    if (!this.routeTree_1.register_ela2uv_k$(Companion_getInstance_2().prependTo_e25c5r_k$(route), pageMethod)) {
  ...
  protoOf(Router).tryRoutingTo_5doa86_k$ = function (pathQueryAndFragment, updateHistoryMode, openLinkStrategy) {
    if (contains(pathQueryAndFragment, '://'))
      return false;
    var pathQueryAndFragment_0 = Companion_getInstance_2().prependTo_e25c5r_k$(pathQueryAndFragment);
    if (Companion_getInstance_4().isRoute_nlgap1_k$(pathQueryAndFragment_0)) {
      ...
      // Inline function 'kotlin.run' call
      var _destruct__k2r9zo = partitionPath(this, pathQueryAndFragment_0);
      ...
      // Inline function 'kotlin.run' call
      var pathPart_0 = partitionPath(this, pathQueryAndFragment_0).component1_7eebsc_k$();
    ...
    var tmp;
    if (updatePageContext(this, Companion_getInstance_0().get_instance_vwsfsk_k$(), pathQueryAndFragment_0)) {
      pathQueryAndFragment_0 = Companion_getInstance_0().get_instance_vwsfsk_k$().get_route_iy3cio_k$().get_path_wos8ry_k$() + partitionPath(this, pathQueryAndFragment_0).get_second_jf7fjx_k$();
      // Inline function 'kotlin.let' call
  ...
  function ComposableSingletons$RouterKt$lambda$231942886$lambda(errorCode, $composer, $changed) {
    var $composer_0 = $composer;
    var $dirty = $changed;
    if (($changed & 6) === 0)
  ...
  function ComposableSingletons$RouterKt() {
    ...
    var tmp = this;
    tmp.lambda$_149473399_dxnuon_1 = ComposableLambda$invoke$ref_2(composableLambdaInstance(-149473399, false, ComposableSingletons$RouterKt$lambda$_149473399$lambda_vw12th));
    var tmp_0 = this;
    tmp_0.lambda$231942886__1 = ComposableLambda$invoke$ref_3(composableLambdaInstance(231942886, false, ComposableSingletons$RouterKt$lambda$231942886$lambda));
  }
  protoOf(ComposableSingletons$RouterKt).get_lambda$_149473399_c46um_k$ = function () {
    return this.lambda$_149473399_dxnuon_1;
  };
  protoOf(ComposableSingletons$RouterKt).get_lambda$231942886_eez9d5_k$ = function () {
    return this.lambda$231942886__1;
  };
  ...
  //endregion
  //region block: init
  com_varabyte_kobweb_core_DefaultStyleSheet$stable = 8;
