(function (factory) {
  ...
  var isDigit = kotlin_kotlin.$_$.xd;
  ...
  var last = kotlin_kotlin.$_$.ce;
  var isUpperCase = kotlin_kotlin.$_$.zd;
  var Char = kotlin_kotlin.$_$.gf;
  var get_lastIndex = kotlin_kotlin.$_$.be;
  var isLowerCase = kotlin_kotlin.$_$.yd;
  ...
  function CssIdent(asStr) {
    ...
    // Inline function 'kotlin.require' call
    if (!!isDigit(charSequenceGet(this.asStr_1, 0))) {
  ...
  protoOf(CssIdent).get_kdzpvg_k$ = function (index) {
    return charSequenceGet(this.asStr_1, index);
  };
  protoOf(CssIdent).subSequence_hm5hnj_k$ = function (startIndex, endIndex) {
    return charSequenceSubSequence(this.asStr_1, startIndex, endIndex);
  };
