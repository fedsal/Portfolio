package org.fedsal.portfolio.components.sections.home.components
...
import org.fedsal.portfolio.components.styles.SocialLinkStyle
import org.fedsal.portfolio.components.utils.Res
import org.fedsal.portfolio.components.widgets.LinkButton
...
fun SocialLinksRow(
    ...
    val bottomPadding = when (breakpoint) {
        Breakpoint.ZERO, Breakpoint.SM, Breakpoint.MD -> 0.5.cssRem
        else -> 0.5.cssRem
    }
